...
const SECTIONS = [
  { n: 1, id: 'acceptance-of-terms', title: 'Acceptance of Terms' },
  {
    n: 2,
  ...
  { n: 4, id: 'acceptable-use-policy', title: 'Acceptable Use Policy' },
  { n: 5, id: 'tracked-social-profiles', title: 'Tracked Social Profiles' },
  { n: 6, id: 'analytics-data', title: 'Analytics Data' },
  { n: 7, id: 'intellectual-property', title: 'Intellectual Property' },
  { n: 8, id: 'third-party-services', title: 'Third-Party Services' },
  {
    n: 9,
    id: 'no-guarantee-of-uptime-or-availability',
    title: 'No Guarantee of Uptime or Availability',
  },
  { n: 10, id: 'disclaimer-of-warranties', title: 'Disclaimer of Warranties' },
  { n: 11, id: 'limitation-of-liability', title: 'Limitation of Liability' },
  { n: 12, id: 'indemnification', title: 'Indemnification' },
  { n: 13, id: 'termination', title: 'Termination' },
  {
    n: 14,
  ...
  { n: 16, id: 'miscellaneous', title: 'Miscellaneous' },
  { n: 17, id: 'contact-us', title: 'Contact Us' },
];
      ...
      <Container>
        <Section space="md">
          <header className="max-w-prose border-b border-line pb-10">
            ...
            <h1 className="mt-4 text-display-2 text-fg">Terms of Service</h1>
          ...
          <div className="mt-10 grid gap-10 lg:mt-14 lg:grid-cols-[15rem_minmax(0,1fr)] lg:gap-16">
            ...
            <div className="max-w-prose">
              <p className={paragraph}>
                ...
                <strong className={inlineStrong}>Terms</strong>&rdquo;) form a
                binding agreement between you (&ldquo;you&rdquo; or
                &ldquo;User&rdquo;) and{' '}
                <strong className={inlineStrong}>D3 Creator</strong> (&ldquo;D3
                Creator&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, or
                &ldquo;us&rdquo;) governing your access to and use of the D3
                Creator website at{' '}
              ...
              <h2 id="acceptance-of-terms" className={sectionTitle}>
              ...
              <ul className={list}>
                <li className={bullet}>
                  You are at least 16 years old, or have reached the age of
              ...
              <h2 id="description-of-the-service" className={sectionTitle}>
                2. Description of the Service
              </h2>
              <p className={paragraph}>
                D3 Creator is an agency-managed social media analytics platform.
                Agencies provision creator accounts and add the public social
                profiles they manage; creators sign in to view combined
                analytics across those profiles in a single dashboard. The
                Service currently supports analytics for Instagram, Facebook,
                TikTok, and Douyin. Public self-signup is not available —
                accounts are created by your agency. We may add or remove
                supported platforms from time to time.
              </p>

              <h2 id="user-accounts-and-registration" className={sectionTitle}>
                3. User Accounts and Registration
              </h2>
              <h3 className={subTitle}>3.1 Account Creation</h3>
              <p className={paragraph}>
                Accounts are provisioned by your agency; public
                self-registration is not available. You agree to keep your
                account credentials secure and your contact information accurate
                and up to date.
              </p>
              ...
              <p className={paragraph}>
                ...
                immediately of any unauthorized access or suspected security
                breach. We are not liable for any loss or damage arising from
                your failure to protect your account credentials.
              </p>
              <h3 className={subTitle}>3.3 One Account Per Person</h3>
              <p className={paragraph}>
                You may not create or use multiple accounts to circumvent
                restrictions or impersonate another person. We reserve the right
                to suspend duplicate accounts.
              </p>

              <h2 id="acceptable-use-policy" className={sectionTitle}>
                4. Acceptable Use Policy
              </h2>
              <p className={paragraph}>
                You agree that you will{' '}
                <strong className={inlineStrong}>not</strong>:
              </p>
              <ul className={list}>
                <li className={bullet}>
                ...
                <li className={bullet}>
                  Track or analyze social profiles that you do not own or are
                  not authorized to track.
                </li>
                <li className={bullet}>
                  Attempt to gain unauthorized access to any part of the
                  Service, its systems, or its data.
                </li>
                <li className={bullet}>
                  Interfere with or disrupt the Service, including by
                  introducing malware, conducting denial-of-service attacks, or
                ...
                <li className={bullet}>
                  Use the Service to harass, defame, or harm any other person or
                  entity.
                </li>
                <li className={bullet}>
                  Scrape, harvest, or otherwise collect data from the Service
                  except through features we expressly provide for that purpose.
                </li>
                <li className={bullet}>
                  Violate the terms of service of any connected social media
                  platform (such as Meta or TikTok) through your use of the
                  Service.
                </li>
              </ul>

              <h2 id="tracked-social-profiles" className={sectionTitle}>
                5. Tracked Social Profiles
              </h2>
              <h3 className={subTitle}>5.1 Profiles You Own</h3>
              <p className={paragraph}>
                D3 Creator tracks public social profiles that are added on your
                behalf by your agency. You represent and warrant that you own,
                or have explicit permission to have us track and analyze, every
                profile associated with your account.
              </p>
              ...
              <p className={paragraph}>
                ...
                from the public profile URL of each tracked profile (Instagram,
                Facebook, TikTok, Douyin), using trusted third-party data
                providers. Your use of the Service must comply with each
                platform&rsquo;s own terms and all applicable laws.
              </p>

              <h2 id="analytics-data" className={sectionTitle}>
                6. Analytics Data
              </h2>
              <p className={paragraph}>
                The Service displays analytics derived from publicly available
                social media data, collected through trusted third-party data
                providers. We do not guarantee:
              </p>
              <ul className={list}>
                <li className={bullet}>
                  The accuracy, completeness, or timeliness of any analytics
                  data displayed.
                </li>
                <li className={bullet}>
                  The continued availability of any platform integration, which
                  may change or be removed if the underlying platform changes
                  its API.
                </li>
                <li className={bullet}>
              ...
              <p className={paragraph}>
                Analytics data is provided for informational purposes only and
                should not be the sole basis for business or financial
                decisions.
              </p>

              <h2 id="intellectual-property" className={sectionTitle}>
                7. Intellectual Property
              </h2>
              <h3 className={subTitle}>7.1 Our Rights</h3>
              <p className={paragraph}>
                The Service, including its software, design, branding (such as
                the &ldquo;D3 Creator&rdquo; name and logo), and content
                (excluding User Content), is owned by us or our licensors and is
              ...
              <p className={paragraph}>
                You retain all rights to your own social media content. The
                Service collects only publicly available data from the profiles
                your agency tracks and uses it solely for the purpose of
                providing the Service to you.
              </p>

              <h2 id="third-party-services" className={sectionTitle}>
                8. Third-Party Services
              </h2>
              <p className={paragraph}>
                The Service relies on third-party services including TikHub and
                BrightData (public social-data collection), Supabase (database
                and storage), and Vercel (hosting). Your use of these
                third-party services is governed by their own terms and privacy
                policies. We are not responsible for the practices,
              ...
              <p className={paragraph}>
                ...
                available at any particular time or location. The Service may be
                temporarily unavailable due to maintenance, upgrades, or events
                outside our reasonable control (including outages of third-party
                APIs and hosting providers).
              </p>
              <p className={paragraph}>
                We are not liable for any downtime, data loss, or inconvenience
                caused by such unavailability.
              </p>

              <h2 id="disclaimer-of-warranties" className={sectionTitle}>
              ...
              <p className={paragraph}>
                ...
                requirements, be free of errors, or produce any specific result.
                Any reliance on the analytics data or other materials provided
                through the Service is at your sole risk.
              </p>

              <h2 id="limitation-of-liability" className={sectionTitle}>
                11. Limitation of Liability
              </h2>
              <p className={paragraph}>
                TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT
                SHALL D3 CREATOR, ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, OR
              ...
              <p className={paragraph}>
                ...
                PAID US IN THE TWELVE (12) MONTHS PRECEDING THE EVENT GIVING
                RISE TO THE LIABILITY, OR ONE HUNDRED MALAYSIAN RINGGIT (MYR
                100), WHICHEVER IS GREATER. WHERE YOU USE THE SERVICE WITHOUT
                PAYMENT, OUR AGGREGATE LIABILITY IS CAPPED AT MYR 100.
              </p>

              <h2 id="indemnification" className={sectionTitle}>
                12. Indemnification
              </h2>
              <p className={paragraph}>
                You agree to indemnify, defend, and hold harmless D3 Creator and
              ...
              <ul className={list}>
                ...
                <li className={bullet}>
                  Your violation of any third-party right, including the terms
                  of any social media platform tracked through the Service.
                </li>
                <li className={bullet}>
              ...
              <h2 id="termination" className={sectionTitle}>
                13. Termination
              </h2>
              <h3 className={subTitle}>13.1 Termination by You</h3>
              <p className={paragraph}>
                You may stop using the Service at any time and ask your agency
                to close your account. Upon deletion, we will process your data
              ...
              <p className={paragraph}>
                ...
                including if you breach these Terms, engage in fraudulent or
              ...
              <p className={paragraph}>
                ...
                time. We may also revise these Terms from time to time. When we
                make material changes, we will update the &ldquo;Last
                Updated&rdquo; date and, where appropriate, provide a more
                prominent notice. Your continued use of the Service after the
              ...
              <p className={paragraph}>
                ...
                laws of <strong className={inlineStrong}>Malaysia</strong>,
              ...
              <p className={paragraph}>
                ...
                in connection with these Terms or the Service, except where such
                exclusive jurisdiction would deprive you of mandatory consumer
                protections available to you under the law of your country of
                residence.
              </p>

              <h2 id="miscellaneous" className={sectionTitle}>
                16. Miscellaneous
              </h2>
              <h3 className={subTitle}>16.1 Entire Agreement</h3>
              <p className={paragraph}>
                These Terms, together with the Privacy Policy, constitute the
                entire agreement between you and D3 Creator regarding the
              ...
              <p className={paragraph}>
                ...
                written consent. We may assign these Terms freely, including in
              ...
              <div className="mt-14 border-t border-line pt-6">
                <p className="text-body-sm text-fg-muted">
                  ...
                  template and do not constitute legal advice. You are
                  responsible for ensuring compliance with all laws applicable
                  to your specific operations. We strongly recommend consulting
                  a qualified legal professional in Malaysia before relying on
                  these terms for production use.
                </p>
              </div>
            </div>
          </div>
