...
export default async function AccountPage() {
  ...
  return (
    <div className="flex flex-col gap-10 pt-12 pb-24 max-w-[640px]">
      ...
      {/* Profile */}
      <section className="bg-surface-subtle border border-line border border-line rounded-2xl p-6 flex flex-col gap-4">
        <div>
      ...
      {/* Identity */}
      <section className="bg-surface-subtle border border-line border border-line rounded-2xl p-6 flex flex-col gap-3">
        <h2 className="text-heading text-fg">Identity</h2>
        <div className="flex items-center justify-between gap-4">
          <div className="min-w-0">
            <div className="text-caption text-fg-subtle">Signed in as</div>
      ...
      <section className="bg-surface-subtle border border-line border border-line rounded-2xl p-6 flex flex-col gap-1">
